...
<div class="mid">
  ...
  <form action="register.php" method="post" , enctype="multipart/form-data" autocomplete="off">
    ...
    <input type="text" id="firstname" name="firstname" required <?php if (isset($_POST["firstname"])) {
                                                                  echo "value=" . $_POST["firstname"];
                                                                } ?>>
    <hr>
    <label for="lastname">Last name</label>
    <input type="text" id="lastname" name="lastname" required <?php if (isset($_POST["lastname"])) {
                                                                echo "value=" . $_POST["lastname"];
                                                              } ?>>
    <hr>
    <label for="bio">Bio</label>
    <textarea name="bio" id="bio" cols="30" rows="5" placeholder=" Start typing here..." style="vertical-align: middle;"><?php if (isset($_POST["bio"])) {
                                                                                                                            echo $_POST["bio"];
                                                                                                                          } ?></textarea>
    <hr>
    ...
    <input type="radio" name="privacy" id="open" value="open" <?php
    ...
    <input type="date" id="dob" name="dob" required <?php if (isset($_POST["dob"])) {
                                                      echo "value=" . $_POST["dob"];
                                                    } ?>>
    <hr>
    <label for="username">Username</label>
    <input type="text" id="username" name="username" required <?php if (isset($_POST["username"])) {
    ...
    <div class=""><?php echo $errors['username']; ?></div>
    <!--Outputs error-->
    <hr>
